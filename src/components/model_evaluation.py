...
class ModelEvaluation:
    def __init__(self, model_trainer_artifact: ModelTrainerArtifacts, model_evaluation_config: ModelEvaluationConfig, data_ingestion_artifact: DataIngestionArtifacts):
    ...
    def get_s3_model(self) -> object:
        ...
        try:
            ...
            if status == True:
                ...
                # If model is not present in s3 bucket then use the best model which is stored in the local system
                try:
                    model = MainUtils.load_object("ShipmentPrice-Prediction/best_model/shipping_price_model.pkl")
                    return model
                except:
                    return None
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        try:
            ...
            logging.info("Exited the initiate_model_evaluation methos of Model evaluation class")
